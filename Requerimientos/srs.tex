...
necesarias tanto para la construcción de la extensión en sí.
...
extensiones que FuL utilizara en esta ejecución. Además este archivo
...
que no presente configuración ni registrado de extensiones alguna.
...
}. En caso de que error ERROR\_EXIT.
...
documento. También se registraran los comandos que cada extensión
...
\item Sino se cumple ninguno de los anteriores se procederá a deslindar
...
FuL, junto con todo el conocimiento que se pueda derivar al agregar
dicho archivo. Finalizado el registrado se deberá mostrar al usuario,
mediante la CLI, el mensaje \emph{IMPORT OK }y\emph{ }se finaliza
