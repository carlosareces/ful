...
la detección de redundancias y obtener una versión minimál de la KB
...
automática de redundancias no puedo asegurar que tenemos una KB minimál,
solo lo podre asegurar cuando estas no existan. Servirá seguir manteniendo
esta característica de la KB minimál o solo queremos quedarnos con
...
invalid parameters}.
\item Si $comm="import"$, leer el requerimiento especificado en \vref{sub:REQ_03}.
\item Si $comm="save"$, leer el requerimiento especificado en \vref{sub:REQ_04}.
\item Si $comm="query"$, leer el requerimiento especificado en \vref{sub:REQ_05}.
\item Si $comm="execute"$, leer el requerimiento especificado en \vref{sub:REQ_06}.
\item Si $comm="show"$, leer el requerimiento especificado en \vref{sub:REQ_07}.
\item Si $comm="set"$, leer el requerimiento especificado en \vref{sub:REQ_08}.
