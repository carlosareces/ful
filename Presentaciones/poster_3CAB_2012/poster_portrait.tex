...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Case Study: Junín Virus}{name=problem,below=intro,span=1}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\small{
	\begin{flushleft}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Solution Approach}{name=solution,below=problem,column=0}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\small{
	\begin{flushleft}
	By modelling the problem of the effects of the temperature change 
	over the behaviour of the Junin virus RNA's secondary structure, 
	a set composed with definitions and another set with rules was obtained:
	\end{flushleft}
	\resizebox{\linewidth}{!} {
  	\begin{tabular}{l l}
	Definitions								& Rules\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{center}
	\includegraphics[width=\linewidth,height=15em]{design}
	\end{center}
	
	The kernel of the tool will be composed of 
	a planner that can handle PDDL (Planning Domain Definition Language) input, 
	...
	\begin{enumerate}
	\smaller{
	\item The KM take the actual state from the planner and sends it to each registered plug-in.
	\item Each plug-in try to enrich that state by derivation of new knowledge by consulting 
		the shared KB and their own, the plug-in can return a enriched state.
	\item The knowledge manager generate the derived state by combining the enriched states 
		received from the plug-ins. If there incongruities between the states received from 
		the plug-ins the KM will report this to the user, otherwise the KM will return the 
		derived state.
	}	
	\end{enumerate}
	FuL will include a semantic reasoner for Description Logics (DL) as one of the plug-ins
	and we will also provide a knowledge representation language for the virology domain based 
	on DL. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \headerbox{User Interface}{name=inteface,column=1,below=design}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	 \small{
	 Via a XML file provided by the user, FuL will register the plug-ins that will 
	 be utilized during that session and configure different session parameters. 
	 Also a initial KB file will be used during the session. FuL will process the 
	 KB file with the plug-ins register in the XML file.
	 Afterwards a prompt-like CLI will be gived to the user that allow to access 
	 the following functionalities:
	 \begin{itemize}\itemsep1pt \parskip0pt \parsep0pt
	 \smaller{
	 \item \textbf{Extend the actual KB by join it with a $\Delta$ KB :} It will 
	 check for incongruities and saturate new KB with atomic concepts derived 
	 from actual KB $\cup\Delta$KB.
	 \item Queries : the answer will be consistent with the actual KB and register
	 plug-ins. If FuL can't arrive to a conclusion it will return a set of questions 
	 that are unanswerable by FuL, to which answers can be added by extending the actual 
	 KB in order to return a define answer.
	 }	 
	 \end{itemize}
	 }
 }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Materials and Methods}{name=method,column=0,below=solution}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \begin{itemize}\itemsep1pt \parskip0pt \parsep0pt
 \scriptsize{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \hfill\includegraphics[width=0.5\linewidth]{chart}
  \end{minipage}
  \end{minipage}
  }
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{References}{name=source,column=1,below=inteface,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \scriptsize{
